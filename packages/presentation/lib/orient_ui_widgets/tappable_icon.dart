...
class _TappableIconState extends State<TappableIcon> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tapController = AnimationController(duration: Style.durations.fast, vsync: this);
              ...
              child: Opacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _isHovered ? colors.surfaceContainer : const Color(0x00000000),
                    shape: BoxShape.circle,
                    boxShadow: _isFocused && !isDisabled
                        ? [BoxShadow(color: colors.foreground.withValues(alpha: 0.2), spreadRadius: 2)]
                        : null,
                  ),
                  child: Center(
                    child: IconTheme(
                      data: IconThemeData(color: isDisabled ? colors.mutedForeground : colors.foreground),
                      child: widget.icon,
                    ),
                  ),
                ),
